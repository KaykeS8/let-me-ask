...
export const FeedbackSucessSteps = ({onFeedbackRestartRequested}: feedbackSucessStepProps) => {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-white text-xl mt-2">Agradecemos o feedback</span>
        <button
        onClick={onFeedbackRestartRequested} 
        className="text-white py-2 px-6 mt-6 bg-brand-300 rounded-md border-transparent text-sm leading-6 hover:trasition-colors  focus:outline-none focus:ring-2 focus:ring-offset-2 focus: ring-offset-zinc-900 focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
